 ...
 * @Modified_By avishekdas @Last_On 04-Apr-2020 7:28:51 pm
 */
...
public class SwaggerConfiguration {
	...
	public Docket apiDocket() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.calendario.user.controller")).paths(PathSelectors.any())
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("User Service Rest Api", "User Details Available", "V-1.0", "API Terms of Service URL",
				new Contact("Calendario", "https://github.com/imavishek/Calendario",
						"calendario.online.2020@gmail.com"),
