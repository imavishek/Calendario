			<div class="footer" style="margin: 0 auto;background: #9a9898;padding: 8px;border-radius: 0px 0px 9px 9px;">
				<div style="display: flex; justify-content: space-between; align-items: center;">
					<div id="footerCompanyDetails" style="font-family: 'Droid Sans', sans-serif;text-align: left;">
						<span id="footerCompanyName" style="color: #8b0000;font-size: 15px;font-weight: bold;font-style: italic;">Calendario</span>
					...
					<div style="display: flex; justify-content: space-between; align-items: center;">
						<div>
							<a href="mailto:calendario.online.2020@gmail.com" target="_top">
			...
			<div class="legalCopy" style="font-weight: normal;font-style: italic;font-size: 12px;color: rgb(126, 129, 140);text-align: center;">
				<p>
					...
					have any queries please email us at <a href="mailto:calendario.online.2020@gmail.com" target="_top">calendario.online.2020@gmail.com</a>
				</p>
			</div>
